...
public enum ErrorCode {
    ...
    PITCH_HAS_BOOKINGS(3005, HttpStatus.BAD_REQUEST, "Sân bóng đã có dữ liệu đặt sân trong lịch sử, không thể xóa. Vui lòng chuyển trạng thái sang Không hoạt động"),
